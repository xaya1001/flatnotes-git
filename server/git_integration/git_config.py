...
def initialize_git_config(global_config):
    ...
    global GIT_ENABLED, GIT_REPO_PATH, GIT_WEBHOOK_SECRET, GIT_REMOTE_NAME
    global GIT_DEFAULT_BRANCH, GIT_COMMIT_USER_NAME, GIT_COMMIT_USER_EMAIL
    global GIT_SSH_COMMAND, GIT_AUTO_FETCH_INTERVAL, GIT_AUTO_INIT, GIT_PULL_STRATEGY
